        ...
        {accountView === "login" ? (
          <form onSubmit={handleLoginSubmit} className="p-6 flex flex-col space-y-5">
            <input
              ...
              className="w-full px-4 py-3 border border-gray-500 rounded-full focus:outline-pink-500 text-sm text-gray-800 placeholder-gray-500"
            />
            <input
            ...
            <motion.button whileHover={{y:-4}}
             type="submit" className="w-full bg-pink-500  shadow-2xl  text-white dancing-script font-medium py-3 rounded-full hover:bg-pink-600 transition-colors text-sm">
              Sign In
            </motion.button>
          ...
          <form onSubmit={handleRegisterSubmit} className="p-6 flex flex-col space-y-5">
            <input
              ...
              className="w-full px-3 py-3 border border-gray-500 rounded-full focus:outline-pink-500 text-sm text-gray-800 placeholder-gray-500"
            />
            <input
            ...
            />
            <motion.button whileHover={{y:-4}}
             type="submit" className="w-full bg-pink-500  dancing-script shadow-2xl  text-white font-medium py-3 rounded-full hover:bg-pink-600 transition-colors text-sm">
              Register
            </motion.button>
            <div className="text-center pt-2">
              <button type="button" onClick={() => setAccountView("login")} className="text-sm text-gray-600 hover:text-black underline transition-colors">
