...
useEffect(() => {
  fetch(`${baseUrl}/api/Product/category/pens`)
    .then(res => {
      if (!res.ok) {
    ...
    .then(data => {
      console.log("Pens Data received successfully:", data);
      setPens(data); // 👈 FIXED HERE!
    })
  ...
  return (
    <div className="bg-gray-100 min-h-screen py-12 flex flex-col">
      ...
      >
        <h1 className="text-4xl font-semibold text-gray-800 dancing-script mt-10">Writing Essentials</h1>
      </motion.div>
            ...
            <div className="p-1">
              ...
              <div className="flex justify-between items-center px-3">
                ...
                className="text-sm underline hover:text-pink-500 transition-colors">
                 ...
                 style={{ fontFamily: "Playfair Display" }}>Rs.{product.price}</p>
