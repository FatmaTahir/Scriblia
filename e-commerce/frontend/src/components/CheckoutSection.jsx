...
const CheckoutSection = () => {
  ...
  return (
    ...
    <div
      ...
      className="bg-white p-4 sm:p-2  shadow-2xl transition-all  rounded-3xl duration-500 animate-fadeIn"
    >
      ...
      <form onSubmit={handlePlaceOrder} className="space-y-2 px-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
          <div className="flex flex-col space-y-2">
            ...
            style={{ fontFamily: "Playfair Display" }}>Full Name *</label>
            <input
              type="text"
              name="fullName"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
          <div className="flex flex-col space-y-2">
            <label className="text-xs font-semibold text-gray-500 "
            style={{ fontFamily: "Playfair Display" }}>WhatsApp Number <span className="text-gray-400 font-normal">(Optional)</span></label>
          ...
          <div className="flex flex-col space-y-2">
            <label className="text-xs font-semibold text-gray-500"
            style={{ fontFamily: "Playfair Display" }}>City *</label>
            <input
              type="text"
              name="city"
              value={formData.city}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
          <div className="flex flex-col space-y-2">
            <label className="text-xs font-semibold text-gray-500"
            style={{ fontFamily: "Playfair Display" }}>Shipping Address *</label>
            <input
              type="text"
              name="address"
          ...
          <div className="flex flex-col space-y-2">
            <label className="text-xs font-semibold text-gray-500"
            style={{ fontFamily: "Playfair Display" }}>Apartment / Suite <span className="text-gray-400 font-normal">(Optional)</span></label>
        ...
        <div className="pt-3 ">
          ...
          style={{ fontFamily: "Playfair Display" }}>Payment Method</h3>
          <div className="bg-gray-50 py-2 px-4 rounded-xl border border-gray-200 ">
            <label className="flex items-center gap-3 cursor-pointer">
              ...
              style={{ fontFamily: "Playfair Display" }}>Cash on Delivery (COD)</span>
            </label>
            <p className="text-xs text-gray-400 pl-7"
            style={{ fontFamily: "Playfair Display" }}>Pay securely using cash once the parcel reaches your doorstep.</p>
          </div>
        </div>
